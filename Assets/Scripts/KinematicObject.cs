...
namespace AGDDPlatformer
{
    public class KinematicObject : MonoBehaviour
    {
        ...
        // --- Added for gravity reversal support ---
        // Flips the cached ground normal so horizontal movement
        // stays correct immediately after gravity is reversed.
        public void FlipGroundNormal()
        {
            groundNormal.y *= -1f;
        }
    }
