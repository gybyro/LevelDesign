...
namespace AGDDPlatformer
{
    public class GameManager : MonoBehaviour
    {
        ...
        {
            KinematicObject[] kinematicObjects = FindObjectsOfType<KinematicObject>();

            foreach (KinematicObject obj in kinematicObjects)
            {
                obj.gravityModifier *= -1f;
                obj.velocity = new Vector2(obj.velocity.x, -obj.velocity.y);
                obj.FlipGroundNormal();
            }
